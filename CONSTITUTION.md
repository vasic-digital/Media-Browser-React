# CONSTITUTION — Media-Browser-React

Project-specific governance for the **Media-Browser-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
